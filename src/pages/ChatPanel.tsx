...
function ChatPanel() {
  ...
  const chatBox = (
    <Box sx={{ paddingLeft: 2, paddingRight: 2 }}>
      ...
      <Box sx={{ borderTop: 1, borderColor: '#333', p: 2 }}>
        {sending && (
          <LinearProgress
            sx={{
  ...
  return (
    <>
      ...
      >
        <DialogTitle sx={{ p: 2, borderBottom: 1, borderColor: '#333' }}>
        ...
        <DialogActions sx={{ p: 2, borderTop: 1, borderColor: '#333', justifyContent: 'flex-end' }}>
          {!submitted ? (
            <Button
              variant="contained"
              onClick={() => {
